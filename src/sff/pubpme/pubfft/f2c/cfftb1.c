/* cfftb1.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int cfftb1_(int *n, double *c__, double *ch, 
	double *wa, int *ifac)
{
    ...
    static int i__, k1, l1, l2, n2, na, nf, ip, iw, ix2, ix3, ix4, nac, 
	    ido, idl1, idot;
    extern /* Subroutine */ int passb_(int *, int *, int *, 
	    int *, int *, double *, double *, double *, 
	    double *, double *, double *), passb2_(int *, 
	    int *, double *, double *, double *), passb3_(
	    int *, int *, double *, double *, double *, 
	    double *), passb4_(int *, int *, double *, 
	    double *, double *, double *, double *), passb5_(
	    int *, int *, double *, double *, double *, 
