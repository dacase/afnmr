/* cfftf1.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int cfftf1_(int *n, double *c__, double *ch, 
	double *wa, int *ifac)
{
    ...
    /* Local variables */
    static int i__, k1, l1, l2, n2, na, nf, ip, iw, ix2, ix3, ix4, nac, 
	    ido, idl1, idot;
    extern /* Subroutine */ int passf_(int *, int *, int *, 
	    int *, int *, double *, double *, double *, 
	    double *, double *, double *), passf2_(int *, 
	    int *, double *, double *, double *), passf3_(
	    int *, int *, double *, double *, double *, 
	    double *), passf4_(int *, int *, double *, 
	    double *, double *, double *, double *), passf5_(
	    int *, int *, double *, double *, double *, 
