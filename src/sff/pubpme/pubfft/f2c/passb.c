/* passb.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int passb_(int *nac, int *ido, int *ip, int *
	...
	double *ch, double *ch2, double *wa)
{
    ...
    /* Local variables */
    static int i__, j, k, l, jc, lc, ik, nt, idj, idl, inc, idp;
    static double wai, war;
    static int ipp2, idij, idlj, idot, ipph;
