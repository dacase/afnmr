...
subroutine bicg(xm,ym,zm,nbnd,nz_num,c,c2,index,index2,bv,phi,xs,&
      itmax,iter,tol,err)
...
!     xs  <- u0
      ...
      call SETA(xm,ym,zm,nbnd,nz_num,index,index2,c,c2,bv,a, f, ia, ja)
      ...
      subroutine SETA(l,m,n,maxirr,nz_num,index,index2,c,c2,ff,a,f,ia,ja)
