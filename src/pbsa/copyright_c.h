...
! equation. The implementation uses the multiple finite-difference methods to solve
...
! Wang, Cai, Xiang, and Luo, J. Chem. Comp. Theo. 8:2741-2751, 2012.
!
! The parameters used in the electrostatic solvation model are optimized and validated
