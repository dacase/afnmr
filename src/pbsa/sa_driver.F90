...
module solvent_accessibility
   ...
   integer               :: triopt
   character (len=8)     :: radires       ! ligand residue name whose radii are to be scaled
   _REAL_                :: radiscale     ! scale factor of ligand radii
   _REAL_                :: protscale     ! scale factor of protein radii
...
subroutine sa_driver( verbose,pbprint,pqropt,sasopt,inp,natom,atmlast,dosas,ndosas,&
...
#  include "pb_constants.h"
   ...
   integer pqropt
   integer sasopt, inp, natom, atmlast, dosas, ndosas, npbstep, nsaslag
